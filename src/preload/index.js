...
import { getReportReciepts, getReportDiscounts, getReportSalesByCustomers } from "./backend/controllers/reports.controller";
...
const api = {
  ...
  // reports
  getReportReciepts, getReportDiscounts, getReportSalesByCustomers
  // reports
}
