...
import { getReportReciepts, getReportDiscounts, getReportSalesByCustomers, getReportSalesByPaymentTypes, getReportSalesByItem, getReportSalesSummary, getDashboardStats, getReportRecieptById } from "./backend/controllers/reports.controller";
...
const api = {
  ...
  getReportSalesByItem, getReportSalesSummary, getDashboardStats, getReportRecieptById,
  // reports
}
